...
1. Админ наказывает игрока через команды EssentialsX (`/ban`, `/mute`, `/kick`, `/warn`, `/jail` и т.д.)
2. PunishNotify перехватывает событие EssentialsX
...
| `events.ban` | true | Уведомления о бане |
| `events.unban` | true | Уведомления о разбане |
| `events.mute` | true | Уведомления о муте |
| `events.unmute` | true | Уведомления о размуте |
| `events.kick` | true | Уведомления о кике |
| `events.warn` | true | Уведомления о предупреждении |
